...
static const char *fonts[] = {
    "SF Pro Display:size=12:antialias=true:autohint=true"};
...
static const Layout layouts[] = {
    ...
    {"|M|", monocle},        {"|D|", deck},
    {"|C|", centeredmaster}, {"|>C|", centeredfloatingmaster},
    {"|@|", spiral},         {"|\\|", dwindle},
};
...
static const char *dmenucmd[] = {"dmenu_run", "-fn", dmenufont,  "-nb",
                                 col_night1,  "-nf", col_snow1,  "-sb",
                                 col_frost3,  "-sf", col_night1, NULL};
...
static Key keys[] = {
    ...
    {Mod1Mask | ShiftMask | ControlMask, XK_b, togglescratch, {.ui = 0}},
    {Mod1Mask | ShiftMask | ControlMask, XK_n, togglescratch, {.ui = 1}},
